...
_getlastcat:     file format elf32-i386
   ...
   7:	31 c0                	xor    %eax,%eax
{
  ...
  10:	51                   	push   %ecx
  char filename[512] = { 0 };
  11:	8d bd fc fd ff ff    	lea    -0x204(%ebp),%edi
  17:	b9 7f 00 00 00       	mov    $0x7f,%ecx
{
  1c:	81 ec 0c 02 00 00    	sub    $0x20c,%esp
  char filename[512] = { 0 };
  22:	c7 85 f8 fd ff ff 00 	movl   $0x0,-0x208(%ebp)
  29:	00 00 00 
  2c:	f3 ab                	rep stos %eax,%es:(%edi)
  getlastcat(filename);
  2e:	8d bd f8 fd ff ff    	lea    -0x208(%ebp),%edi
  34:	57                   	push   %edi
  35:	e8 09 03 00 00       	call   343 <getlastcat>
  printf(1, "XV6_TEST_OUTPUT Last catted filename: %s", filename);
  3a:	83 c4 0c             	add    $0xc,%esp
  3d:	57                   	push   %edi
  3e:	68 28 07 00 00       	push   $0x728
  43:	6a 01                	push   $0x1
  45:	e8 b6 03 00 00       	call   400 <printf>
  exit();
  4a:	e8 54 02 00 00       	call   2a3 <exit>
  4f:	90                   	nop
 ...
 409:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 479:	ff 24 85 58 07 00 00 	jmp    *0x758(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 587:	90                   	nop
          s = "(null)";
 588:	ba 51 07 00 00       	mov    $0x751,%edx
        while(*s != 0){
...
000005a0 <free>:
 5a0:	55                   	push   %ebp
 5a1:	a1 5c 0a 00 00       	mov    0xa5c,%eax
 ...
 5e1:	5b                   	pop    %ebx
 5e2:	89 15 5c 0a 00 00    	mov    %edx,0xa5c
 5e8:	5e                   	pop    %esi
 5e9:	5f                   	pop    %edi
 5ea:	5d                   	pop    %ebp
 5eb:	c3                   	ret    
 ...
 61c:	89 15 5c 0a 00 00    	mov    %edx,0xa5c
...
00000630 <malloc>:
 ...
 63c:	8b 3d 5c 0a 00 00    	mov    0xa5c,%edi
 ...
 681:	8b 3d 5c 0a 00 00    	mov    0xa5c,%edi
 ...
 6af:	8b 15 5c 0a 00 00    	mov    0xa5c,%edx
 ...
 6f7:	0a 00 00 
 6fa:	bf 60 0a 00 00       	mov    $0xa60,%edi
 6ff:	c7 05 60 0a 00 00 60 	movl   $0xa60,0xa60
 706:	0a 00 00 
 709:	89 fa                	mov    %edi,%edx
 70b:	c7 05 64 0a 00 00 00 	movl   $0x0,0xa64
 712:	00 00 00 
