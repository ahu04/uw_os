...
80100028:	bc f0 56 11 80       	mov    $0x801156f0,%esp
...
80100505:	e8 96 59 00 00       	call   80105ea0 <uartputc>
8010050a:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
80100511:	e8 8a 59 00 00       	call   80105ea0 <uartputc>
80100516:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
8010051d:	e8 7e 59 00 00       	call   80105ea0 <uartputc>
...
80102088:	68 c2 7a 10 80       	push   $0x80107ac2
...
801024d2:	81 fb f0 56 11 80    	cmp    $0x801156f0,%ebx
...
80103022:	e8 a9 2a 00 00       	call   80105ad0 <idtinit>
...
80103046:	e8 75 3b 00 00       	call   80106bc0 <switchkvm>
  seginit();
8010304b:	e8 e0 3a 00 00       	call   80106b30 <seginit>
  lapicinit();
...
80103077:	68 f0 56 11 80       	push   $0x801156f0
...
80103090:	e8 9b 3a 00 00       	call   80106b30 <seginit>
  picinit();       // disable pic
...
801030a4:	e8 17 2d 00 00       	call   80105dc0 <uartinit>
  pinit();         // process table
801030a9:	e8 22 08 00 00       	call   801038d0 <pinit>
  tvinit();        // trap vectors
801030ae:	e8 9d 29 00 00       	call   80105a50 <tvinit>
  binit();         // buffer cache
...
80103824:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103827:	c7 40 14 42 5a 10 80 	movl   $0x80105a42,0x14(%eax)
  p->context = (struct context*)sp;
...
801039b3:	e8 78 36 00 00       	call   80107030 <setupkvm>
...
801039d1:	e8 0a 33 00 00       	call   80106ce0 <inituvm>
...
80103abb:	e8 10 31 00 00       	call   80106bd0 <switchuvm>
  return 0;
...
80103ada:	e8 71 33 00 00       	call   80106e50 <allocuvm>
...
80103afa:	e8 81 34 00 00       	call   80106f80 <deallocuvm>
...
80103b48:	e8 d3 35 00 00       	call   80107120 <copyuvm>
...
80103c80:	e8 4b 2f 00 00       	call   80106bd0 <switchuvm>
...
80103c92:	e8 e4 0b 00 00       	call   8010487b <swtch>
      switchkvm();
80103c97:	e8 24 2f 00 00       	call   80106bc0 <switchkvm>
      c->proc = 0;
...
80103f89:	e8 22 30 00 00       	call   80106fb0 <freevm>
        p->pid = 0;
...
801041fb:	68 1f 7d 10 80       	push   $0x80107d1f
...
80104a7c:	8b 14 85 40 7a 10 80 	mov    -0x7fef85c0(,%eax,4),%edx
...
80104aa8:	68 1d 7a 10 80       	push   $0x80107a1d
...
80104c04:	68 b8 7a 10 80       	push   $0x80107ab8
...
80104c1c:	68 b7 7a 10 80       	push   $0x80107ab7
...
80104c31:	68 ab 7a 10 80       	push   $0x80107aab
...
80104c4f:	68 ba 7a 10 80       	push   $0x80107aba
80104c54:	e8 27 b7 ff ff       	call   80100380 <panic>
    panic("create: ialloc");
80104c59:	83 ec 0c             	sub    $0xc,%esp
80104c5c:	68 9c 7a 10 80       	push   $0x80107a9c
...
80104cf4:	53                   	push   %ebx
  if(argint(n, &fd) < 0)
80104cf5:	8d 75 f4             	lea    -0xc(%ebp),%esi
{
...
80104d08:	0f 88 92 00 00 00    	js     80104da0 <sys_read+0xb0>
  if(fd < 0 || fd >= NOFILE || (f=myproc()->ofile[fd]) == 0)
80104d0e:	83 7d f4 0f          	cmpl   $0xf,-0xc(%ebp)
80104d12:	0f 87 88 00 00 00    	ja     80104da0 <sys_read+0xb0>
80104d18:	e8 53 ec ff ff       	call   80103970 <myproc>
80104d1d:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104d20:	8b 5c 90 28          	mov    0x28(%eax,%edx,4),%ebx
80104d24:	85 db                	test   %ebx,%ebx
80104d26:	74 78                	je     80104da0 <sys_read+0xb0>
  if(fd < 0 || argint(2, &n) < 0 || argptr(1, &p, n) < 0)
80104d28:	83 ec 08             	sub    $0x8,%esp
80104d2b:	8d 45 f0             	lea    -0x10(%ebp),%eax
80104d2e:	50                   	push   %eax
80104d2f:	6a 02                	push   $0x2
80104d31:	e8 ea fb ff ff       	call   80104920 <argint>
80104d36:	83 c4 10             	add    $0x10,%esp
80104d39:	85 c0                	test   %eax,%eax
80104d3b:	78 63                	js     80104da0 <sys_read+0xb0>
80104d3d:	83 ec 04             	sub    $0x4,%esp
80104d40:	ff 75 f0             	push   -0x10(%ebp)
80104d43:	56                   	push   %esi
80104d44:	6a 01                	push   $0x1
80104d46:	e8 25 fc ff ff       	call   80104970 <argptr>
80104d4b:	83 c4 10             	add    $0x10,%esp
80104d4e:	85 c0                	test   %eax,%eax
80104d50:	78 4e                	js     80104da0 <sys_read+0xb0>
  struct proc *curproc = myproc();
80104d52:	e8 19 ec ff ff       	call   80103970 <myproc>
  if (strncmp("cat", curproc->name, 3) == 0 && !open_called) {
80104d57:	83 ec 04             	sub    $0x4,%esp
80104d5a:	83 c0 6c             	add    $0x6c,%eax
80104d5d:	6a 03                	push   $0x3
80104d5f:	50                   	push   %eax
80104d60:	68 ca 7a 10 80       	push   $0x80107aca
80104d65:	e8 06 fa ff ff       	call   80104770 <strncmp>
80104d6a:	83 c4 10             	add    $0x10,%esp
80104d6d:	0b 05 60 3c 11 80    	or     0x80113c60,%eax
80104d73:	74 1b                	je     80104d90 <sys_read+0xa0>
  return fileread(f, p, n);
80104d75:	83 ec 04             	sub    $0x4,%esp
80104d78:	ff 75 f0             	push   -0x10(%ebp)
80104d7b:	ff 75 f4             	push   -0xc(%ebp)
80104d7e:	53                   	push   %ebx
80104d7f:	e8 9c c2 ff ff       	call   80101020 <fileread>
...
80104d8e:	66 90                	xchg   %ax,%ax
    cat_status = CAT_NO_ARGS;
80104d90:	c7 05 08 a0 10 80 fd 	movl   $0xfffffffd,0x8010a008
80104d97:	ff ff ff 
80104d9a:	eb d9                	jmp    80104d75 <sys_read+0x85>
80104d9c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    return -1;
80104da0:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104da5:	eb e0                	jmp    80104d87 <sys_read+0x97>
...
8010509d:	58                   	pop    %eax
8010509e:	5a                   	pop    %edx
8010509f:	68 b8 7a 10 80       	push   $0x80107ab8
...
801050b8:	68 b7 7a 10 80       	push   $0x80107ab7
...
80105236:	83 ec 2c             	sub    $0x2c,%esp
  char *path;
  int fd, omode;
  struct file *f;
  struct inode *ip;
  int in_cat = 0;
  struct proc *curproc = myproc();
80105239:	e8 32 e7 ff ff       	call   80103970 <myproc>

  if (strncmp("cat", curproc->name, 3) == 0) {
8010523e:	83 ec 04             	sub    $0x4,%esp
80105241:	83 c0 6c             	add    $0x6c,%eax
80105244:	6a 03                	push   $0x3
80105246:	50                   	push   %eax
80105247:	68 ca 7a 10 80       	push   $0x80107aca
8010524c:	e8 1f f5 ff ff       	call   80104770 <strncmp>
80105251:	83 c4 10             	add    $0x10,%esp
80105254:	85 c0                	test   %eax,%eax
80105256:	0f 85 8c 00 00 00    	jne    801052e8 <sys_open+0xb8>
    in_cat = 1;
    open_called = 1;
  }
...
8010525f:	8d 45 e0             	lea    -0x20(%ebp),%eax
    open_called = 1;
80105262:	c7 05 60 3c 11 80 01 	movl   $0x1,0x80113c60
80105269:	00 00 00 
  if(argstr(0, &path) < 0 || argint(1, &omode) < 0) {
8010526c:	50                   	push   %eax
8010526d:	6a 00                	push   $0x0
8010526f:	e8 6c f7 ff ff       	call   801049e0 <argstr>
80105274:	83 c4 10             	add    $0x10,%esp
80105277:	85 c0                	test   %eax,%eax
80105279:	0f 88 21 01 00 00    	js     801053a0 <sys_open+0x170>
8010527f:	83 ec 08             	sub    $0x8,%esp
80105282:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80105285:	50                   	push   %eax
80105286:	6a 01                	push   $0x1
80105288:	e8 93 f6 ff ff       	call   80104920 <argint>
8010528d:	83 c4 10             	add    $0x10,%esp
80105290:	85 c0                	test   %eax,%eax
80105292:	0f 88 08 01 00 00    	js     801053a0 <sys_open+0x170>
    in_cat = 1;
80105298:	c7 45 d4 01 00 00 00 	movl   $0x1,-0x2c(%ebp)
      cat_status = -1;
    }
    return -1;
  }
...
801052a8:	0f 85 82 00 00 00    	jne    80105330 <sys_open+0x100>
        cat_status = -1;
      }
      return -1;
    }
...
801052b1:	ff 75 e0             	push   -0x20(%ebp)
801052b4:	e8 e7 cd ff ff       	call   801020a0 <namei>
801052b9:	83 c4 10             	add    $0x10,%esp
801052bc:	89 c6                	mov    %eax,%esi
801052be:	85 c0                	test   %eax,%eax
801052c0:	0f 84 6a 01 00 00    	je     80105430 <sys_open+0x200>
      if (in_cat) {
        cat_status = -1;
      }
      return -1;
...
801052ca:	e8 b1 c4 ff ff       	call   80101780 <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
801052cf:	83 c4 10             	add    $0x10,%esp
801052d2:	66 83 7e 50 01       	cmpw   $0x1,0x50(%esi)
801052d7:	75 78                	jne    80105351 <sys_open+0x121>
801052d9:	8b 5d e4             	mov    -0x1c(%ebp),%ebx
801052dc:	85 db                	test   %ebx,%ebx
801052de:	74 71                	je     80105351 <sys_open+0x121>
801052e0:	e9 9f 00 00 00       	jmp    80105384 <sys_open+0x154>
801052e5:	8d 76 00             	lea    0x0(%esi),%esi
  if(argstr(0, &path) < 0 || argint(1, &omode) < 0) {
801052e8:	83 ec 08             	sub    $0x8,%esp
801052eb:	8d 45 e0             	lea    -0x20(%ebp),%eax
801052ee:	50                   	push   %eax
801052ef:	6a 00                	push   $0x0
801052f1:	e8 ea f6 ff ff       	call   801049e0 <argstr>
801052f6:	83 c4 10             	add    $0x10,%esp
801052f9:	85 c0                	test   %eax,%eax
801052fb:	0f 88 3f 01 00 00    	js     80105440 <sys_open+0x210>
80105301:	83 ec 08             	sub    $0x8,%esp
80105304:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80105307:	50                   	push   %eax
80105308:	6a 01                	push   $0x1
8010530a:	e8 11 f6 ff ff       	call   80104920 <argint>
8010530f:	83 c4 10             	add    $0x10,%esp
80105312:	85 c0                	test   %eax,%eax
80105314:	0f 88 26 01 00 00    	js     80105440 <sys_open+0x210>
  int in_cat = 0;
8010531a:	c7 45 d4 00 00 00 00 	movl   $0x0,-0x2c(%ebp)
  begin_op();
80105321:	e8 3a da ff ff       	call   80102d60 <begin_op>
  if(omode & O_CREATE){
80105326:	f6 45 e5 02          	testb  $0x2,-0x1b(%ebp)
8010532a:	0f 84 7e ff ff ff    	je     801052ae <sys_open+0x7e>
    ip = create(path, T_FILE, 0, 0);
80105330:	83 ec 0c             	sub    $0xc,%esp
80105333:	8b 45 e0             	mov    -0x20(%ebp),%eax
80105336:	31 c9                	xor    %ecx,%ecx
80105338:	ba 02 00 00 00       	mov    $0x2,%edx
8010533d:	6a 00                	push   $0x0
8010533f:	e8 8c f7 ff ff       	call   80104ad0 <create>
    if(ip == 0){
...
8010534b:	0f 84 df 00 00 00    	je     80105430 <sys_open+0x200>
      }
      return -1;
    }
  }
...
80105351:	e8 da ba ff ff       	call   80100e30 <filealloc>
80105356:	89 c7                	mov    %eax,%edi
80105358:	85 c0                	test   %eax,%eax
8010535a:	74 28                	je     80105384 <sys_open+0x154>
  struct proc *curproc = myproc();
8010535c:	e8 0f e6 ff ff       	call   80103970 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
80105361:	31 db                	xor    %ebx,%ebx
80105363:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80105367:	90                   	nop
    if(curproc->ofile[fd] == 0){
80105368:	8b 4c 98 28          	mov    0x28(%eax,%ebx,4),%ecx
8010536c:	85 c9                	test   %ecx,%ecx
8010536e:	74 48                	je     801053b8 <sys_open+0x188>
  for(fd = 0; fd < NOFILE; fd++){
80105370:	83 c3 01             	add    $0x1,%ebx
80105373:	83 fb 10             	cmp    $0x10,%ebx
80105376:	75 f0                	jne    80105368 <sys_open+0x138>
    if(f)
      fileclose(f);
80105378:	83 ec 0c             	sub    $0xc,%esp
8010537b:	57                   	push   %edi
8010537c:	e8 6f bb ff ff       	call   80100ef0 <fileclose>
80105381:	83 c4 10             	add    $0x10,%esp
    iunlockput(ip);
80105384:	83 ec 0c             	sub    $0xc,%esp
80105387:	56                   	push   %esi
80105388:	e8 83 c6 ff ff       	call   80101a10 <iunlockput>
    end_op();
8010538d:	e8 3e da ff ff       	call   80102dd0 <end_op>
    if (in_cat) {
80105392:	8b 45 d4             	mov    -0x2c(%ebp),%eax
80105395:	83 c4 10             	add    $0x10,%esp
80105398:	85 c0                	test   %eax,%eax
8010539a:	0f 84 a0 00 00 00    	je     80105440 <sys_open+0x210>
      cat_status = -1;
801053a0:	c7 05 08 a0 10 80 ff 	movl   $0xffffffff,0x8010a008
801053a7:	ff ff ff 
    return -1;
801053aa:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
801053af:	eb 47                	jmp    801053f8 <sys_open+0x1c8>
...
801053c5:	e8 06 da ff ff       	call   80102dd0 <end_op>
  ...
  if (in_cat) {
801053ca:	8b 55 d4             	mov    -0x2c(%ebp),%edx
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
801053cd:	83 c4 10             	add    $0x10,%esp
  f->ip = ip;
801053d0:	89 77 10             	mov    %esi,0x10(%edi)
  f->type = FD_INODE;
801053d3:	c7 07 02 00 00 00    	movl   $0x2,(%edi)
  f->readable = !(omode & O_WRONLY);
801053d9:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
  f->off = 0;
801053dc:	c7 47 14 00 00 00 00 	movl   $0x0,0x14(%edi)
  f->readable = !(omode & O_WRONLY);
801053e3:	89 c8                	mov    %ecx,%eax
801053e5:	f7 d0                	not    %eax
801053e7:	83 e0 01             	and    $0x1,%eax
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
801053ea:	83 e1 03             	and    $0x3,%ecx
  f->readable = !(omode & O_WRONLY);
801053ed:	88 47 08             	mov    %al,0x8(%edi)
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
801053f0:	0f 95 47 09          	setne  0x9(%edi)
  if (in_cat) {
801053f4:	85 d2                	test   %edx,%edx
801053f6:	75 10                	jne    80105408 <sys_open+0x1d8>
    strncpy(last_cat_filename, path, FILE_NAME_SZ);
    cat_status = fd;
  }
  return fd;
}
801053f8:	8d 65 f4             	lea    -0xc(%ebp),%esp
801053fb:	89 d8                	mov    %ebx,%eax
801053fd:	5b                   	pop    %ebx
801053fe:	5e                   	pop    %esi
801053ff:	5f                   	pop    %edi
80105400:	5d                   	pop    %ebp
...
8010540b:	68 00 02 00 00       	push   $0x200
80105410:	ff 75 e0             	push   -0x20(%ebp)
80105413:	68 80 3c 11 80       	push   $0x80113c80
80105418:	e8 a3 f3 ff ff       	call   801047c0 <strncpy>
    cat_status = fd;
8010541d:	89 1d 08 a0 10 80    	mov    %ebx,0x8010a008
80105423:	83 c4 10             	add    $0x10,%esp
}
80105426:	8d 65 f4             	lea    -0xc(%ebp),%esp
80105429:	89 d8                	mov    %ebx,%eax
8010542b:	5b                   	pop    %ebx
8010542c:	5e                   	pop    %esi
8010542d:	5f                   	pop    %edi
8010542e:	5d                   	pop    %ebp
...
80105430:	e8 9b d9 ff ff       	call   80102dd0 <end_op>
      if (in_cat) {
80105435:	8b 75 d4             	mov    -0x2c(%ebp),%esi
80105438:	85 f6                	test   %esi,%esi
8010543a:	0f 85 60 ff ff ff    	jne    801053a0 <sys_open+0x170>
      return -1;
80105440:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
80105445:	eb b1                	jmp    801053f8 <sys_open+0x1c8>
...
8010547f:	e8 4c f6 ff ff       	call   80104ad0 <create>
...
8010548f:	e8 7c c5 ff ff       	call   80101a10 <iunlockput>
  end_op();
80105494:	e8 37 d9 ff ff       	call   80102dd0 <end_op>
  return 0;
...
801054c4:	e8 17 f5 ff ff       	call   801049e0 <argstr>
...
801054d9:	e8 42 f4 ff ff       	call   80104920 <argint>
  if((argstr(0, &path)) < 0 ||
...
801054ee:	e8 2d f4 ff ff       	call   80104920 <argint>
     argint(1, &major) < 0 ||
...
8010550e:	e8 bd f5 ff ff       	call   80104ad0 <create>
     argint(2, &minor) < 0 ||
...
8010551e:	e8 ed c4 ff ff       	call   80101a10 <iunlockput>
  end_op();
80105523:	e8 a8 d8 ff ff       	call   80102dd0 <end_op>
  return 0;
...
8010556f:	e8 2c cb ff ff       	call   801020a0 <namei>
...
80105581:	e8 fa c1 ff ff       	call   80101780 <ilock>
  if(ip->type != T_DIR){
...
8010559d:	e8 0e c3 ff ff       	call   801018b0 <iput>
  end_op();
801055a2:	e8 29 d8 ff ff       	call   80102dd0 <end_op>
  curproc->cwd = ip;
...
801055c4:	e8 47 c4 ff ff       	call   80101a10 <iunlockput>
    end_op();
801055c9:	e8 02 d8 ff ff       	call   80102dd0 <end_op>
    return -1;
...
80105605:	e8 d6 f3 ff ff       	call   801049e0 <argstr>
...
80105621:	e8 fa f2 ff ff       	call   80104920 <argint>
...
80105640:	e8 1b f0 ff ff       	call   80104660 <memset>
...
8010566a:	e8 21 f2 ff ff       	call   80104890 <fetchint>
...
80105688:	e8 43 f2 ff ff       	call   801048d0 <fetchstr>
...
801056c5:	e8 e6 b3 ff ff       	call   80100ab0 <exec>
...
801056f1:	e8 7a f2 ff ff       	call   80104970 <argptr>
...
80105708:	e8 23 dd ff ff       	call   80103430 <pipealloc>
...
80105717:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80105719:	e8 52 e2 ff ff       	call   80103970 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105736:	e8 b5 b7 ff ff       	call   80100ef0 <fileclose>
    fileclose(wf);
8010573b:	58                   	pop    %eax
8010573c:	ff 75 e4             	push   -0x1c(%ebp)
8010573f:	e8 ac b7 ff ff       	call   80100ef0 <fileclose>
    return -1;
...
80105776:	75 f0                	jne    80105768 <sys_pipe+0x88>
      myproc()->ofile[fd0] = 0;
80105778:	e8 f3 e1 ff ff       	call   80103970 <myproc>
...
801057b3:	83 ec 18             	sub    $0x18,%esp
  char* buf = (char*) 0;
  open_called = 0;
801057b6:	c7 05 60 3c 11 80 00 	movl   $0x0,0x80113c60
801057bd:	00 00 00 
  char* buf = (char*) 0;
801057c0:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  begin_op();
801057c7:	e8 94 d5 ff ff       	call   80102d60 <begin_op>
  if(argptr(0, &buf, FILE_NAME_SZ) < 0) {
801057cc:	83 ec 04             	sub    $0x4,%esp
801057cf:	8d 45 f4             	lea    -0xc(%ebp),%eax
801057d2:	68 00 02 00 00       	push   $0x200
801057d7:	50                   	push   %eax
801057d8:	6a 00                	push   $0x0
801057da:	e8 91 f1 ff ff       	call   80104970 <argptr>
801057df:	83 c4 10             	add    $0x10,%esp
801057e2:	85 c0                	test   %eax,%eax
801057e4:	78 7f                	js     80105865 <sys_getlastcat+0xb5>
    end_op();
    return -1;
  }
  if (buf == (char*) 0) {
...
801057eb:	74 78                	je     80105865 <sys_getlastcat+0xb5>
    end_op();
    return -1;
  }

  if (cat_status == CAT_NOT_YET_RUN) {
801057ed:	a1 08 a0 10 80       	mov    0x8010a008,%eax
801057f2:	83 f8 fe             	cmp    $0xfffffffe,%eax
801057f5:	74 41                	je     80105838 <sys_getlastcat+0x88>
    strncpy(buf, "Cat has not yet been called", 28);
  } else if (cat_status == CAT_NO_ARGS) {
801057f7:	83 f8 fd             	cmp    $0xfffffffd,%eax
801057fa:	74 54                	je     80105850 <sys_getlastcat+0xa0>
    // called with no args
    strncpy(buf, "No args were passed", 20);
  } else if (cat_status == -1) {
801057fc:	83 f8 ff             	cmp    $0xffffffff,%eax
801057ff:	74 1f                	je     80105820 <sys_getlastcat+0x70>
    // cat failed
    strncpy(buf, "Invalid filename", 17);
  } else {
    // cat succeeded
    strncpy(buf, last_cat_filename, FILE_NAME_SZ);
80105801:	83 ec 04             	sub    $0x4,%esp
80105804:	68 00 02 00 00       	push   $0x200
80105809:	68 80 3c 11 80       	push   $0x80113c80
8010580e:	52                   	push   %edx
8010580f:	e8 ac ef ff ff       	call   801047c0 <strncpy>
80105814:	83 c4 10             	add    $0x10,%esp
  }

  end_op();
80105817:	e8 b4 d5 ff ff       	call   80102dd0 <end_op>
  return 0;
...
80105823:	6a 11                	push   $0x11
80105825:	68 31 7b 10 80       	push   $0x80107b31
8010582a:	52                   	push   %edx
8010582b:	e8 90 ef ff ff       	call   801047c0 <strncpy>
80105830:	83 c4 10             	add    $0x10,%esp
80105833:	eb e2                	jmp    80105817 <sys_getlastcat+0x67>
80105835:	8d 76 00             	lea    0x0(%esi),%esi
    strncpy(buf, "Cat has not yet been called", 28);
80105838:	83 ec 04             	sub    $0x4,%esp
8010583b:	6a 1c                	push   $0x1c
8010583d:	68 01 7b 10 80       	push   $0x80107b01
80105842:	52                   	push   %edx
80105843:	e8 78 ef ff ff       	call   801047c0 <strncpy>
80105848:	83 c4 10             	add    $0x10,%esp
8010584b:	eb ca                	jmp    80105817 <sys_getlastcat+0x67>
8010584d:	8d 76 00             	lea    0x0(%esi),%esi
    strncpy(buf, "No args were passed", 20);
80105850:	83 ec 04             	sub    $0x4,%esp
80105853:	6a 14                	push   $0x14
80105855:	68 1d 7b 10 80       	push   $0x80107b1d
8010585a:	52                   	push   %edx
8010585b:	e8 60 ef ff ff       	call   801047c0 <strncpy>
80105860:	83 c4 10             	add    $0x10,%esp
80105863:	eb b2                	jmp    80105817 <sys_getlastcat+0x67>
    end_op();
80105865:	e8 66 d5 ff ff       	call   80102dd0 <end_op>
    return -1;
...
{
  return fork();
80105880:	e9 8b e2 ff ff       	jmp    80103b10 <fork>
...
80105893:	83 ec 08             	sub    $0x8,%esp
  exit();
80105896:	e8 f5 e4 ff ff       	call   80103d90 <exit>
...
{
  return wait();
801058a0:	e9 1b e6 ff ff       	jmp    80103ec0 <wait>
...
801058bc:	e8 5f f0 ff ff       	call   80104920 <argint>
...
801058ce:	e8 8d e8 ff ff       	call   80104160 <kill>
...
801058f3:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
801058f6:	e8 75 e0 ff ff       	call   80103970 <myproc>
...
80105917:	78 27                	js     80105940 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
80105919:	e8 52 e0 ff ff       	call   80103970 <myproc>
  if(growproc(n) < 0)
...
80105926:	e8 65 e1 ff ff       	call   80103a90 <growproc>
...
8010595d:	e8 be ef ff ff       	call   80104920 <argint>
...
80105970:	68 a0 3e 11 80       	push   $0x80113ea0
80105975:	e8 26 ec ff ff       	call   801045a0 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
8010597a:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
8010597d:	8b 1d 80 3e 11 80    	mov    0x80113e80,%ebx
  while(ticks - ticks0 < n){
...
80105993:	68 a0 3e 11 80       	push   $0x80113ea0
80105998:	68 80 3e 11 80       	push   $0x80113e80
8010599d:	e8 9e e6 ff ff       	call   80104040 <sleep>
  while(ticks - ticks0 < n){
801059a2:	a1 80 3e 11 80       	mov    0x80113e80,%eax
...
801059c0:	68 a0 3e 11 80       	push   $0x80113ea0
801059c5:	e8 76 eb ff ff       	call   80104540 <release>
  }
  release(&tickslock);
  return 0;
}
...
801059e3:	68 a0 3e 11 80       	push   $0x80113ea0
801059e8:	e8 53 eb ff ff       	call   80104540 <release>
  return 0;
...
80105a04:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105a07:	68 a0 3e 11 80       	push   $0x80113ea0
80105a0c:	e8 8f eb ff ff       	call   801045a0 <acquire>
  xticks = ticks;
80105a11:	8b 1d 80 3e 11 80    	mov    0x80113e80,%ebx
  release(&tickslock);
80105a17:	c7 04 24 a0 3e 11 80 	movl   $0x80113ea0,(%esp)
80105a1e:	e8 1d eb ff ff       	call   80104540 <release>
  return xticks;
}
...
80105a60:	8b 14 85 0c a0 10 80 	mov    -0x7fef5ff4(,%eax,4),%edx
80105a67:	c7 04 c5 e2 3e 11 80 	movl   $0x8e000008,-0x7feec11e(,%eax,8)
80105a6e:	08 00 00 8e 
80105a72:	66 89 14 c5 e0 3e 11 	mov    %dx,-0x7feec120(,%eax,8)
80105a79:	80 
80105a7a:	c1 ea 10             	shr    $0x10,%edx
80105a7d:	66 89 14 c5 e6 3e 11 	mov    %dx,-0x7feec11a(,%eax,8)
80105a84:	80 
  for(i = 0; i < 256; i++)
...
80105a8f:	83 ec 08             	sub    $0x8,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105a92:	a1 0c a1 10 80       	mov    0x8010a10c,%eax
80105a97:	c7 05 e2 40 11 80 08 	movl   $0xef000008,0x801140e2
80105a9e:	00 00 ef 
  initlock(&tickslock, "time");
80105aa1:	68 42 7b 10 80       	push   $0x80107b42
80105aa6:	68 a0 3e 11 80       	push   $0x80113ea0
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105aab:	66 a3 e0 40 11 80    	mov    %ax,0x801140e0
80105ab1:	c1 e8 10             	shr    $0x10,%eax
80105ab4:	66 a3 e6 40 11 80    	mov    %ax,0x801140e6
  initlock(&tickslock, "time");
80105aba:	e8 11 e9 ff ff       	call   801043d0 <initlock>
}
...
80105adb:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80105adf:	b8 e0 3e 11 80       	mov    $0x80113ee0,%eax
...
80105b24:	ff 24 85 e8 7b 10 80 	jmp    *-0x7fef8418(,%eax,4)
...
80105b2f:	90                   	nop
  ...
  case T_IRQ0 + IRQ_IDE:
    ideintr();
80105b30:	e8 0b c7 ff ff       	call   80102240 <ideintr>
    lapiceoi();
80105b35:	e8 d6 cd ff ff       	call   80102910 <lapiceoi>
  }
...
80105b3a:	e8 31 de ff ff       	call   80103970 <myproc>
80105b3f:	85 c0                	test   %eax,%eax
80105b41:	74 1d                	je     80105b60 <trap+0x60>
80105b43:	e8 28 de ff ff       	call   80103970 <myproc>
...
80105b72:	0f 84 b8 00 00 00    	je     80105c30 <trap+0x130>
  ...
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105b78:	e8 f3 dd ff ff       	call   80103970 <myproc>
...
80105bb0:	e8 bb dd ff ff       	call   80103970 <myproc>
...
80105be1:	e8 8a dd ff ff       	call   80103970 <myproc>
...
80105c05:	68 a4 7b 10 80       	push   $0x80107ba4
80105c0a:	e8 91 aa ff ff       	call   801006a0 <cprintf>
    myproc()->killed = 1;
80105c0f:	83 c4 20             	add    $0x20,%esp
80105c12:	e8 59 dd ff ff       	call   80103970 <myproc>
80105c17:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105c1e:	e8 4d dd ff ff       	call   80103970 <myproc>
...
80105c34:	0f 85 3e ff ff ff    	jne    80105b78 <trap+0x78>
    yield();
80105c3a:	e8 b1 e3 ff ff       	call   80103ff0 <yield>
...
80105c4f:	e8 fc dc ff ff       	call   80103950 <cpuid>
80105c54:	57                   	push   %edi
80105c55:	56                   	push   %esi
80105c56:	50                   	push   %eax
80105c57:	68 4c 7b 10 80       	push   $0x80107b4c
80105c5c:	e8 3f aa ff ff       	call   801006a0 <cprintf>
    lapiceoi();
80105c61:	e8 aa cc ff ff       	call   80102910 <lapiceoi>
    break;
80105c66:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105c69:	e8 02 dd ff ff       	call   80103970 <myproc>
...
80105c95:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105c98:	e8 c3 ed ff ff       	call   80104a60 <syscall>
    if(myproc()->killed)
80105c9d:	e8 ce dc ff ff       	call   80103970 <myproc>
...
80105cb3:	5d                   	pop    %ebp
      exit();
80105cb4:	e9 d7 e0 ff ff       	jmp    80103d90 <exit>
80105cb9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    uartintr();
80105cc0:	e8 3b 02 00 00       	call   80105f00 <uartintr>
    lapiceoi();
80105cc5:	e8 46 cc ff ff       	call   80102910 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105cca:	e8 a1 dc ff ff       	call   80103970 <myproc>
...
80105cdc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    kbdintr();
80105ce0:	e8 eb ca ff ff       	call   801027d0 <kbdintr>
    lapiceoi();
...
80105d10:	68 a0 3e 11 80       	push   $0x80113ea0
80105d15:	e8 86 e8 ff ff       	call   801045a0 <acquire>
      wakeup(&ticks);
80105d1a:	c7 04 24 80 3e 11 80 	movl   $0x80113e80,(%esp)
      ticks++;
80105d21:	83 05 80 3e 11 80 01 	addl   $0x1,0x80113e80
      wakeup(&ticks);
80105d28:	e8 d3 e3 ff ff       	call   80104100 <wakeup>
      release(&tickslock);
80105d2d:	c7 04 24 a0 3e 11 80 	movl   $0x80113ea0,(%esp)
80105d34:	e8 07 e8 ff ff       	call   80104540 <release>
...
{
  if(!uart)
80105d90:	a1 e0 46 11 80       	mov    0x801146e0,%eax
...
80105e17:	74 78                	je     80105e91 <uartinit+0xd1>
  uart = 1;
80105e19:	c7 05 e0 46 11 80 01 	movl   $0x1,0x801146e0
80105e20:	00 00 00 
...
80105e2c:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105e2f:	bf 68 7c 10 80       	mov    $0x80107c68,%edi
80105e34:	be fd 03 00 00       	mov    $0x3fd,%esi
  ioapicenable(IRQ_COM1, 0);
80105e39:	6a 00                	push   $0x0
80105e3b:	6a 04                	push   $0x4
80105e3d:	e8 3e c6 ff ff       	call   80102480 <ioapicenable>
  for(p="xv6...\n"; *p; p++)
80105e42:	c6 45 e7 78          	movb   $0x78,-0x19(%ebp)
  ioapicenable(IRQ_COM1, 0);
80105e46:	83 c4 10             	add    $0x10,%esp
80105e49:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  if(!uart)
80105e50:	a1 e0 46 11 80       	mov    0x801146e0,%eax
80105e55:	bb 80 00 00 00       	mov    $0x80,%ebx
80105e5a:	85 c0                	test   %eax,%eax
80105e5c:	75 14                	jne    80105e72 <uartinit+0xb2>
80105e5e:	eb 23                	jmp    80105e83 <uartinit+0xc3>
    microdelay(10);
80105e60:	83 ec 0c             	sub    $0xc,%esp
80105e63:	6a 0a                	push   $0xa
80105e65:	e8 c6 ca ff ff       	call   80102930 <microdelay>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
80105e6a:	83 c4 10             	add    $0x10,%esp
80105e6d:	83 eb 01             	sub    $0x1,%ebx
80105e70:	74 07                	je     80105e79 <uartinit+0xb9>
80105e72:	89 f2                	mov    %esi,%edx
80105e74:	ec                   	in     (%dx),%al
80105e75:	a8 20                	test   $0x20,%al
80105e77:	74 e7                	je     80105e60 <uartinit+0xa0>
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80105e79:	0f b6 45 e7          	movzbl -0x19(%ebp),%eax
80105e7d:	ba f8 03 00 00       	mov    $0x3f8,%edx
80105e82:	ee                   	out    %al,(%dx)
  for(p="xv6...\n"; *p; p++)
80105e83:	0f b6 47 01          	movzbl 0x1(%edi),%eax
80105e87:	83 c7 01             	add    $0x1,%edi
80105e8a:	88 45 e7             	mov    %al,-0x19(%ebp)
80105e8d:	84 c0                	test   %al,%al
80105e8f:	75 bf                	jne    80105e50 <uartinit+0x90>
}
...
80105ea0 <uartputc>:
  if(!uart)
80105ea0:	a1 e0 46 11 80       	mov    0x801146e0,%eax
80105ea5:	85 c0                	test   %eax,%eax
80105ea7:	74 47                	je     80105ef0 <uartputc+0x50>
{
...
80105f0b:	e8 70 a9 ff ff       	call   80100880 <consoleintr>
}
...
8010699c:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
801069a2:	83 ec 1c             	sub    $0x1c,%esp
801069a5:	89 4d e0             	mov    %ecx,-0x20(%ebp)
801069a8:	39 d3                	cmp    %edx,%ebx
801069aa:	73 49                	jae    801069f5 <deallocuvm.part.0+0x65>
801069ac:	89 c7                	mov    %eax,%edi
801069ae:	eb 0c                	jmp    801069bc <deallocuvm.part.0+0x2c>
801069b0:	83 c0 01             	add    $0x1,%eax
801069b3:	c1 e0 16             	shl    $0x16,%eax
801069b6:	89 c3                	mov    %eax,%ebx
801069b8:	39 da                	cmp    %ebx,%edx
801069ba:	76 39                	jbe    801069f5 <deallocuvm.part.0+0x65>
801069bc:	89 d8                	mov    %ebx,%eax
801069be:	c1 e8 16             	shr    $0x16,%eax
801069c1:	8b 0c 87             	mov    (%edi,%eax,4),%ecx
801069c4:	f6 c1 01             	test   $0x1,%cl
801069c7:	74 e7                	je     801069b0 <deallocuvm.part.0+0x20>
801069c9:	89 de                	mov    %ebx,%esi
801069cb:	81 e1 00 f0 ff ff    	and    $0xfffff000,%ecx
801069d1:	c1 ee 0a             	shr    $0xa,%esi
801069d4:	81 e6 fc 0f 00 00    	and    $0xffc,%esi
801069da:	8d b4 31 00 00 00 80 	lea    -0x80000000(%ecx,%esi,1),%esi
801069e1:	85 f6                	test   %esi,%esi
801069e3:	74 cb                	je     801069b0 <deallocuvm.part.0+0x20>
801069e5:	8b 06                	mov    (%esi),%eax
801069e7:	a8 01                	test   $0x1,%al
801069e9:	75 15                	jne    80106a00 <deallocuvm.part.0+0x70>
801069eb:	81 c3 00 10 00 00    	add    $0x1000,%ebx
801069f1:	39 da                	cmp    %ebx,%edx
801069f3:	77 c7                	ja     801069bc <deallocuvm.part.0+0x2c>
801069f5:	8b 45 e0             	mov    -0x20(%ebp),%eax
801069f8:	8d 65 f4             	lea    -0xc(%ebp),%esp
801069fb:	5b                   	pop    %ebx
801069fc:	5e                   	pop    %esi
801069fd:	5f                   	pop    %edi
801069fe:	5d                   	pop    %ebp
801069ff:	c3                   	ret    
80106a00:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80106a05:	74 25                	je     80106a2c <deallocuvm.part.0+0x9c>
80106a07:	83 ec 0c             	sub    $0xc,%esp
80106a0a:	05 00 00 00 80       	add    $0x80000000,%eax
80106a0f:	89 55 e4             	mov    %edx,-0x1c(%ebp)
80106a12:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106a18:	50                   	push   %eax
80106a19:	e8 a2 ba ff ff       	call   801024c0 <kfree>
80106a1e:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
80106a24:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80106a27:	83 c4 10             	add    $0x10,%esp
80106a2a:	eb 8c                	jmp    801069b8 <deallocuvm.part.0+0x28>
80106a2c:	83 ec 0c             	sub    $0xc,%esp
80106a2f:	68 e6 75 10 80       	push   $0x801075e6
80106a34:	e8 47 99 ff ff       	call   80100380 <panic>
...
80106a65:	89 45 e0             	mov    %eax,-0x20(%ebp)
80106a68:	eb 3d                	jmp    80106aa7 <mappages+0x67>
...
80106a9c:	3b 5d dc             	cmp    -0x24(%ebp),%ebx
80106a9f:	74 6f                	je     80106b10 <mappages+0xd0>
80106aa1:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106aa7:	8b 45 e0             	mov    -0x20(%ebp),%eax
80106aaa:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
...
80106aca:	89 45 d8             	mov    %eax,-0x28(%ebp)
80106acd:	68 00 10 00 00       	push   $0x1000
80106ad2:	6a 00                	push   $0x0
80106ad4:	50                   	push   %eax
80106ad5:	e8 86 db ff ff       	call   80104660 <memset>
80106ada:	8b 55 d8             	mov    -0x28(%ebp),%edx
...
80106b1d:	68 70 7c 10 80       	push   $0x80107c70
...
80106b36:	e8 15 ce ff ff       	call   80103950 <cpuid>
...
80106bc0 <switchkvm>:
80106bc0:	a1 e4 46 11 80       	mov    0x801146e4,%eax
...
80106bfa:	e8 51 d8 ff ff       	call   80104450 <pushcli>
80106bff:	e8 ec cc ff ff       	call   801038f0 <mycpu>
80106c04:	89 c3                	mov    %eax,%ebx
80106c06:	e8 e5 cc ff ff       	call   801038f0 <mycpu>
80106c0b:	89 c7                	mov    %eax,%edi
80106c0d:	e8 de cc ff ff       	call   801038f0 <mycpu>
80106c12:	83 c7 08             	add    $0x8,%edi
80106c15:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106c18:	e8 d3 cc ff ff       	call   801038f0 <mycpu>
...
80106d0f:	e8 4c d9 ff ff       	call   80104660 <memset>
80106d14:	58                   	pop    %eax
...
80106d28:	e8 13 fd ff ff       	call   80106a40 <mappages>
80106d2d:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106d30:	89 75 10             	mov    %esi,0x10(%ebp)
80106d33:	83 c4 10             	add    $0x10,%esp
80106d36:	89 5d 08             	mov    %ebx,0x8(%ebp)
80106d39:	89 45 0c             	mov    %eax,0xc(%ebp)
80106d3c:	8d 65 f4             	lea    -0xc(%ebp),%esp
80106d3f:	5b                   	pop    %ebx
80106d40:	5e                   	pop    %esi
80106d41:	5f                   	pop    %edi
80106d42:	5d                   	pop    %ebp
80106d43:	e9 b8 d9 ff ff       	jmp    80104700 <memmove>
80106d48:	83 ec 0c             	sub    $0xc,%esp
80106d4b:	68 b5 7c 10 80       	push   $0x80107cb5
80106d50:	e8 2b 96 ff ff       	call   80100380 <panic>
80106d55:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
80106db0:	68 cf 7c 10 80       	push   $0x80107ccf
...
80106e38:	68 70 7d 10 80       	push   $0x80107d70
...
80106e5c:	8b 7d 08             	mov    0x8(%ebp),%edi
80106e5f:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106e62:	85 c0                	test   %eax,%eax
80106e64:	0f 88 b6 00 00 00    	js     80106f20 <allocuvm+0xd0>
80106e6a:	3b 45 0c             	cmp    0xc(%ebp),%eax
80106e6d:	8b 45 0c             	mov    0xc(%ebp),%eax
80106e70:	0f 82 9a 00 00 00    	jb     80106f10 <allocuvm+0xc0>
80106e76:	8d b0 ff 0f 00 00    	lea    0xfff(%eax),%esi
80106e7c:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
80106e82:	39 75 10             	cmp    %esi,0x10(%ebp)
80106e85:	77 44                	ja     80106ecb <allocuvm+0x7b>
80106e87:	e9 87 00 00 00       	jmp    80106f13 <allocuvm+0xc3>
...
80106e9b:	e8 c0 d7 ff ff       	call   80104660 <memset>
80106ea0:	58                   	pop    %eax
...
80106eb4:	e8 87 fb ff ff       	call   80106a40 <mappages>
...
80106ecb:	e8 b0 b7 ff ff       	call   80102680 <kalloc>
...
80106ed9:	68 ed 7c 10 80       	push   $0x80107ced
80106ede:	e8 bd 97 ff ff       	call   801006a0 <cprintf>
...
80106ef5:	e8 96 fa ff ff       	call   80106990 <deallocuvm.part.0>
...
80106f3b:	68 05 7d 10 80       	push   $0x80107d05
80106f40:	e8 5b 97 ff ff       	call   801006a0 <cprintf>
...
80106f57:	e8 34 fa ff ff       	call   80106990 <deallocuvm.part.0>
80106f5c:	83 ec 0c             	sub    $0xc,%esp
80106f5f:	53                   	push   %ebx
80106f60:	e8 5b b5 ff ff       	call   801024c0 <kfree>
...
80106f90:	5d                   	pop    %ebp
80106f91:	e9 fa f9 ff ff       	jmp    80106990 <deallocuvm.part.0>
...
80106fcb:	e8 c0 f9 ff ff       	call   80106990 <deallocuvm.part.0>
...
8010701c:	68 21 7d 10 80       	push   $0x80107d21
...
801070bb:	a3 e4 46 11 80       	mov    %eax,0x801146e4
...
801070ec:	68 32 7d 10 80       	push   $0x80107d32
...
80107133:	0f 84 bd 00 00 00    	je     801071f6 <copyuvm+0xd6>
80107139:	8b 4d 0c             	mov    0xc(%ebp),%ecx
8010713c:	85 c9                	test   %ecx,%ecx
8010713e:	0f 84 b2 00 00 00    	je     801071f6 <copyuvm+0xd6>
...
80107162:	68 3c 7d 10 80       	push   $0x80107d3c
...
8010718d:	a8 01                	test   $0x1,%al
8010718f:	0f 84 9f 00 00 00    	je     80107234 <copyuvm+0x114>
80107195:	89 c7                	mov    %eax,%edi
80107197:	25 ff 0f 00 00       	and    $0xfff,%eax
8010719c:	89 45 e4             	mov    %eax,-0x1c(%ebp)
8010719f:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
801071a5:	e8 d6 b4 ff ff       	call   80102680 <kalloc>
801071aa:	89 c3                	mov    %eax,%ebx
801071ac:	85 c0                	test   %eax,%eax
801071ae:	74 64                	je     80107214 <copyuvm+0xf4>
801071b0:	83 ec 04             	sub    $0x4,%esp
801071b3:	81 c7 00 00 00 80    	add    $0x80000000,%edi
801071b9:	68 00 10 00 00       	push   $0x1000
801071be:	57                   	push   %edi
801071bf:	50                   	push   %eax
801071c0:	e8 3b d5 ff ff       	call   80104700 <memmove>
801071c5:	58                   	pop    %eax
801071c6:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
801071cc:	5a                   	pop    %edx
801071cd:	ff 75 e4             	push   -0x1c(%ebp)
801071d0:	b9 00 10 00 00       	mov    $0x1000,%ecx
801071d5:	89 f2                	mov    %esi,%edx
801071d7:	50                   	push   %eax
801071d8:	8b 45 e0             	mov    -0x20(%ebp),%eax
801071db:	e8 60 f8 ff ff       	call   80106a40 <mappages>
801071e0:	83 c4 10             	add    $0x10,%esp
801071e3:	85 c0                	test   %eax,%eax
801071e5:	78 21                	js     80107208 <copyuvm+0xe8>
801071e7:	81 c6 00 10 00 00    	add    $0x1000,%esi
801071ed:	39 75 0c             	cmp    %esi,0xc(%ebp)
801071f0:	0f 87 5a ff ff ff    	ja     80107150 <copyuvm+0x30>
...
80107237:	68 56 7d 10 80       	push   $0x80107d56
...
801072f0:	e8 0b d4 ff ff       	call   80104700 <memmove>
